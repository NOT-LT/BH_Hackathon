...
router.post("/subscribe", async (req, res) => {
  try {
    ...
    await transporter.sendMail({
      ...
      to: aLabelEmail,
      subject: "مرحباً بك في نشرة بوابة القبول العالمي",
      text: `
    مرحباً بك في نشرة بوابة القبول العالمي!
    شكراً لاشتراكك في النشرة الإخبارية. سنبقيك على اطلاع بآخر الأخبار والفعاليات القادمة.
    - آخر الأخبار والتحديثات
    - معلومات عن الفعاليات القادمة
    - نصائح ومصادر مفيدة
    
    مع أطيب التحيات،
    فريق بوابة القبول العالمي
      `,
      html: `
      <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#F4F4F5; padding:20px; font-family:Arial, sans-serif; direction:rtl;">
        <tr>
          <td align="center">
            <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="background:#ffffff; border-radius:8px; overflow:hidden;">
              ...
              <tr>
                <td style="padding:30px;">
                  <h2 style="margin-top:0; color:#2c3e50; font-size:20px;">مرحباً بك في نشرة بوابة القبول العالمي! 🚀</h2>
                  <p style="font-size:16px; color:#4a4a4a; line-height:1.6;">
                    شكرًا لاشتراكك في نشرتنا الإخبارية. فيما يلي بعض مما سنرسله لك:
                  </p>
                  <ul style="font-size:16px; color:#4a4a4a; line-height:1.6; padding-inline-start:20px; margin:10px 0;">
                    <li>آخر الأخبار والتحديثات</li>
                    <li>معلومات عن الفعاليات القادمة</li>
                    <li>نصائح ومصادر مفيدة</li>
                  </ul>
                  <p style="font-size:16px; color:#4a4a4a; line-height:1.6;">
                    نتطلع إلى مشاركتك الفاعلة في مجتمعنا، وإلى أن نراك قريبًا في أحد فعالياتنا!
                  </p>
                  <div style="text-align:center; margin:30px 0;">
                    <a href="http://xn----jnc1cf3b4ig.xn--mgbcpq6gpa1a/" style="background-color:#2563EB; color:#ffffff; text-decoration:none; padding:12px 24px; border-radius:4px; font-size:16px;">
                      تصفح موقعنا
                    </a>
                  </div>
                  <p style="font-size:14px; color:#888888; line-height:1.4;">
                    إذا كان لديك أي استفسار أو تحتاج للمساعدة، لا تتردد في الرد على هذا البريد.
                  </p>
                </td>
              </tr>
              ...
              <!-- Footer -->
              <tr>
                <td style="background-color:#F4F4F5; text-align:center; padding:20px; font-size:12px; color:#888888;">
                  بوابة القبول العالمي<br/>
